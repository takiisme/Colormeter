...
To evaluate the performance of the correction methods, we define an accuracy threshold.
...
The coefficient estimates (see \cref{tab:boot}) support this observation.\todo{Elaborate on the table.}
...
but the correction methods leads to a reduction in variance.
