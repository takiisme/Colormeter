...
On average, the median Euclidean error is reduced by 55\% when applying scaling correction relative to uncorrected colors, while the full and reduced models yield a reduction of $65\%$ and $66\%$, respectively.
...
We find that color 11, which possesses the largest green ($G$) channel intensity in the dataset, \todo{
