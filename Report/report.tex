...
\twocolumn[
\icmltitle{Robustness and Generalization in Smartphone-Based Colorimetry:\\A Comparative Analysis of Deterministic and Data-Driven Correction Methods}
...
The observation is further supported by \cref{tab:boot}, which shows the pitch and roll coefficient estimates of the full model fitted on the training set along with their $95\%$ bootstrap confidence intervals.
Both pitch and roll have non-significant effects on color correction.
Based on these observations, we focus on the reduced model in subsequent analysis.
