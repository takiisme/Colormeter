...
We further compared the app's correction-by-scaling method (\cref{sec:scaling})\todo{
    Mention that our app can do this, but we do not do this in data collection?
} with a modeling approach (\cref{sec:model}).
...
\cref{tab:boot} shows the pitch and roll coefficient estimates of the full model along with bootstrap confidence intervals.
We observe no significant effect of the roll angle on the corrected colors.
