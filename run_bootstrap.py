...
corrector_model = CorrectionByModel(space=ColorSpace.LAB, r=4, degree=1, boundary_penalty_factor=0.0, pose=True)
corrector_model.train_with_bootstrap(df_train, n_iterations=1000, alpha=0.05)
np.save('Data/boot_coeffs_pose=True.npy', corrector_model.bootstrapped_coeffs)
